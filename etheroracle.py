...
def write_to_json(gprecs, prediction_table):
    ...
    try:
        ...
        filepath_gprecs = 'json/ethergas.json'
        filepath_prediction_table = 'json/predictTable.json'

        os.makedirs(os.path.dirname(filepath_gprecs), exist_ok=True)
...
def master_control():
    ...
    def init (block):
        ...
        for pastblock in range((block-200), (block), 1):
